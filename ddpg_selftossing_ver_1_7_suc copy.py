...
CFG = {
    ...
    # -------- PD 제어 --------
    "kp": 10.0 * np.array([0.8, 0.5, 0.3, 0.1, 0.05, 0.01]), # PD 제어 비례 상수
    "kd": 0,
    "max_vel": 0.5, # rad/s
    ...
    # -------- 저장 경로 --------
    "save_dir": "rl_results/SelfTossing_TD3_fixed_goal",
...
class SpaceRobotEnv(gym.Env):
    ...
    def reset(self, *, seed=None, options=None):
        ...
        self.data.qpos= rng.uniform(-np.pi/18, np.pi/18, 6)
