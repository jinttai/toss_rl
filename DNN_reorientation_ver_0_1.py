...
CFG = {
    ...
    "velocity_threshold": 0.5, # 릴리즈 성공 판단을 위한 속도 임계값 (기존 유지)
    ...
    "save_dir": "rl_results/SelfTossing_DenseReward_HER_Velocity_ver2", # 경로명 변경하여 구분
    "actor_save_path": "actor_ddpg_her_dense_originit_v1_4.pth",
    "critic_save_path": "critic_ddpg_her_dense_originit_v1_4.pth",
    "results_save_path": "training_results_her_dense_originit_v1_4.npz"
}
